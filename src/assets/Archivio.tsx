...
interface Archive01IconProps extends React.SVGProps<SVGSVGElement> {
  active?: boolean;
}

const Archive01Icon: React.FC<Archive01IconProps> = ({ active = false, ...props }) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      fill="#1e1e1e" // puntino sempre visibile nero
    />
    <path
      d="M2 7H10"
      stroke={active ? "#0088FF" : "#1e1e1e"}
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      fill="#1e1e1e" // puntino interno nero
    />
    <path
      d="M12 9.00019L19 7"
      stroke={active ? "#0088FF" : "#1e1e1e"}
