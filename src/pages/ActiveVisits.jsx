...
const ActiveVisits = () => {
  ...
  { name: 'Ora Inizio Eff', selector: row => row.oraInizioEff, sortable: true },
...
const data = [
  ...
  return (
    <div className="active-visit">
      <div className="active-top">
        ...
        <div className="active-filter-box">
          ...
          <input
            ...
            style={{ minWidth: 80, maxWidth: 160, width: '100%' }}
          />
        </div>
      ...
      <DataTable columns={columns} data={data} pagination responsive highlightOnHover/>
